...
<head>
    ...
    <script type="text/javascript">
        function showProcessImage(processDefinitionId) {
            var url = "${pageContext.request.contextPath}/processDefinition/" + processDefinitionId + "/showProcessImage";
        ...
        <c:forEach items="${processDefinitionList}" var="processDefinition">
            <tr class="TableDetail1 template">
                ...
                <td><a onClick="return delConfirm()"
                       href="${pageContext.request.contextPath}/processDefinition/${processDefinition.key}/delete">删除</a>
                    <a onclick="showProcessImage('${processDefinition.id}')" href="#">查看流程图</a>
                </td>
            </tr>
        </c:forEach>
                    ...
                    <td>
                        <div class="FuncBtn">
                            ...
                            <div class=FuncBtnMemo><a
                                    href="${pageContext.request.contextPath}/processDefinition/deploy">部署流程定义文档</a>
                            </div>
