...
<!--显示表单内容-->
<div id=MainArea>
    <form action="${pageContext.request.contextPath}/workflow/submit" method="post" enctype="multipart/form-data">
        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr>
                        <td><a href="javascript:void(0)" onclick="downloadTemplate(${template.templateId})"
                               style="text-decoration: underline">[点击下载文档模板文件]</a></td>

                        <script type="text/javascript">
                            function downloadTemplate(templateId) {
                                window.location.href = "${pageContext.request.contextPath}/template/download/" + templateId;
                            }
                        </script>
                    </tr>
                </table>
            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr>
                        ...
                        <td><input type="file" name="applicationDocumentPath" class="InputStyle" style="width:450px;"/>
                            *
                        </td>
                    </tr>
                </table>
